...
class DocumentProcessor:
    ...
    def _initialize_converter(self):
        ...
        Create converter only once, only when needed.
        """
    ...
    def _extract_chunk_metadata(self, idx: int, chunk) -> ChunkWithMetaData:
        ...
        This function standardizes a raw Docling chunk into a cleaner metadata-rich chunk 
        that the RAG pipeline can store, search, and trace back to PDF pages.
